...
Usage:
  python 10_patients_activity_variation_jurkatinf.py \
      -i ../data/activity/OL53_retro_Jurkat_infg_activity_withreplicates.tsv \
      -o ../results/patients_variation_jurkatinfg/activity_vs_variance --base-id-reps 3
...
PATIENT_ACTIVITY_PREFIX = "activity_INFg_"
