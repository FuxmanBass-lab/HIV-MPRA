...
# This also writes: *_SPglobal_<metric>.pdf/png
    ...
    python 10_plot_patients_activity_variation_tile13_jurkat.py \
  --presence ../results/motif_grammar/tile13_site_presence_fixedbins.tsv \
  --counts   ../results/motif_grammar/tile13_site_combination_counts_fixedbins.tsv \
  --baseline ../data/activity/OL53_run_Jurkat_berkay_activity.tsv \
  --variation ../results/patients_variation_jurkat/activity_vs_variance_activity_variation_metrics.tsv \
  --min-n 3 \
  --order-by baseline \
  --baseline-and-variation\
  --outfig ../results/figures/variation/variation_jurkat/tile13_grammar_activity_CD4_3iso
  ...
  --counts   ../results/motif_grammar/tile13_site_combination_counts_fixedbins.tsv \
  --baseline ../data/activity/OL53_run_Jurkat_berkay_activity.tsv \
  --variation ../results/patients_variation_jurkatinfg/activity_vs_variance_activity_variation_metrics.tsv \
  --min-n 3 \
  --order-by baseline \
  --baseline-and-variation\
  --outfig ../results/figures/variation/variation_jurkatinfg/tile13_grammar_activity_CD4_3iso
"""
