...
Usage:
  python 10_patients_activity_variation_jurkat.py \
      -i ../data/activity/OL53_retro_Jurkat_activity_withreplicates.tsv \
      -o ../results/patients_variation_jurkat/activity_vs_variance --base-id-reps 3
...
PATIENT_ACTIVITY_PREFIX = "activity_Ctrl_"
